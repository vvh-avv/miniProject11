...
<body bgcolor="#ffffff" text="#000000">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
		...
		<tr>
			<td width="104" class="ct_write">구매번호 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle" />
			</td>
		...
		<tr>
			<td width="104" class="ct_write">구매자아이디 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle" />
			</td>
			<td bgcolor="D6D6D6" width="1"></td>
